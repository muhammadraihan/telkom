...
@section('title', 'Stock Item Create')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Stock Item</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => 'stock_item.store','method' => 'POST','class' =>
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('amount',null,['placeholder' => 'Amount','class' => 'form-control '.($errors->has('amount') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
