...
<div class="subheader">
    <h1 class="subheader-title">
        <i class='subheader-icon fal fa-file-excel'></i> Export: <span class='fw-300'>Total Module Handle
            Percentage</span>
        <small>
            Module for export total module handle percentage data.
        </small>
    </h1>
</div>
<div class="row">
    <div class="col-lg-12 col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>
                    MODULE HANDLE PERCENTAGE
                </h2>
            </div>
            <div class="panel-container show">
                {!! Form::open(['route' => 'download.total-module-percentage','method'=>'POST']) !!}
