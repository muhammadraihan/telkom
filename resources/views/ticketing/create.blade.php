...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
                <h2>Add New <span class="fw-300"><i>Ticketing</i></span></h2>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {!! Form::select('uuid_pelanggan', $pelanggan, '', ['class' => 'pelanggan
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('kerusakan', '',['placeholder' => 'Kerusakan','class' => 'form-control '.($errors->has('kerusakan') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {!! Form::select('status_garansi', array('0' => 'Non Warranty', '1' => 'Warranty'), '', ['class' => 'garansi form-control'.($errors->has('status_garansi') ? 'is-invalid':''), 'required'
