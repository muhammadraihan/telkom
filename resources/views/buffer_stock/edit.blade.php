...
@section('title', 'Buffer Stock Edit')
...
<div class="row">
    <div class="col-xl-6">
        <div id="panel-1" class="panel">
            <div class="panel-hdr">
            <h2>Edit <span class="fw-300"><i>{{$buffer_stock->stockItem->serial_number}}</i></span></h2>
                <div class="panel-toolbar">
                    <a class="nav-link active" href="{{route('buffer_stock.index')}}"><i class="fal fa-arrow-alt-left">
                        </i>
            ...
            <div class="panel-container show">
                <div class="panel-content">
                    ...
                    {!! Form::open(['route' => ['buffer_stock.update',$buffer_stock->uuid],'method' => 'PUT','class' =>
                    'needs-validation','novalidate']) !!}
                    <div class="form-group col-md-4 mb-3">
                        {{ Form::label('stock_item_uuid','Serial Number',['class' => 'required form-label'])}}
                        {!! Form::select('stock_item_uuid', $stock_item, $buffer_stock->stock_item_uuid, ['class' => 'stock_item
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {{ Form::text('buffer_ammount', $buffer_stock->buffer_ammount,['placeholder' => 'Buffer Amount','class' => 'form-control '.($errors->has('buffer_ammount') ? 'is-invalid':''),'required', 'autocomplete' => 'off'])}}
                    ...
                    <div class="form-group col-md-4 mb-3">
                        ...
                        {!! Form::select('office_city', $kota, $buffer_stock->office_city, ['class' => 'office_city
